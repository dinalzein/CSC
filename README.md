...
The results below present the time in sec to reach a precision of 0.01 using the state-of-the-art CSC solvers for univariate signals for different values of the sparsity constraint <img src ="https://latex.codecogs.com/svg.image?\bg{white}\lambda" />.
